...
/**
 * Utility class for password hashing, verification, encryption, and decryption.
...
public final class Passwords {
    ...
    public static String generateRandomPassword(int length) {
        ...
        password.append(Cryptography.randomString(1, uppercase));
        password.append(Cryptography.randomString(1, lowercase));
        password.append(Cryptography.randomString(1, digits));
        password.append(Cryptography.randomString(1, special));
        password.append(Cryptography.randomString(length - 4, allChars));
    ...
    public static boolean isStrongPassword(String password) {
        ...
        for (char c : password.toCharArray()) {
            if (Character.isUpperCase(c)) {
                ...
                hasSpecial = true; // Not uppercase, lowercase, or digit
            }
        }
